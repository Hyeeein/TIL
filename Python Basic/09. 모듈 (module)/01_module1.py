...
# '_heapq', '_imp', '_io', '_json', '_locale',
# '_lsprof', '_md5', '_multibytecodec', '_opcode',
# '_operator', '_pickle', '_random',
# '_sha1', '_sha256', '_sha3', '_sha512',
# '_signal', '_sre', '_stat', '_statistics',
# '_string', '_struct', '_symtable', '_thread',
# '_tracemalloc', '_warnings', '_weakref', '_winapi',
# '_xxsubinterpreters', 'array', 'atexit', 'audioop',
# 'binascii', 'builtins', 'cmath', 'errno', 'faulthandler',
