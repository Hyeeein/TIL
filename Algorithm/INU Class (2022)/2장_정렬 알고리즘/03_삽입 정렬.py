...
# 삽입 정렬 실행 시간 출력 (원소의 개수 5000개)
# N 값은 5000~25000을 5000 간격으로 바꿔서 돌리기 (추가 경우의 수 5가지)
N = 25000
a = []; b= []; c = []
...
삽입 정렬의 실행 시간 (N = 25000) : 0.004
정렬 완료
삽입 정렬의 실행 시간 (N = 25000) : 83.486
정렬 완료
삽입 정렬의 실행 시간 (N = 25000) : 56.530
정렬 완료
'''
